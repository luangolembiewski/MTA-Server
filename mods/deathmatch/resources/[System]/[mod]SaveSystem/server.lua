...
function onLogout ()
	kickPlayer (source, "Servidor: ", "Você deslogou da cidade!")
end
...
function Start_Group ( _, acc )
    ...
    setElementData(source,"ACLs",acls)
  elseif eventName == "onPlayerLogout" then
    removeElementData( source, "ACLs" )
...
addEventHandler("onResourceStart", resourceRoot, Start_Group)
addEventHandler("onPlayerLogout", root, Start_Group)
addEventHandler("onPlayerLogin", root, Start_Group)