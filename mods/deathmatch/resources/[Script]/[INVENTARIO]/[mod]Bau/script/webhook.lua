...
function sendDiscordMessage(titulo, mensagem)
    bot = Webhook(config.webhook, "Bot bau")
    --bot = WHSetAvatar(bot, "https://cdn.discordapp.com/attachments/764883406025785355/913248489348157490/emoji.png")
    bot = WHSetEmbed(bot, titulo)
    bot = WHESetColor(bot, "00000000")
    bot = WHESetDescription(bot, mensagem)
    --bot = WHESetField(bot, "Arena Host", "https://discord.com/invite/c6YYZCByM9", false)
    --bot = WHESetThumbnail(bot, "https://cdn.discordapp.com/attachments/764883406025785355/913248489348157490/emoji.png")
    --bot = WHESetFooter(bot, "©️ ArenaMTA - Todos os direitos reservados.", "https://cdn.discordapp.com/attachments/764883406025785355/913248489348157490/emoji.png")
    WHSend(bot, false)
end
